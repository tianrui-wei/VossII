...
/* This document provides tools to place line modules and manipulate their
   posiitons. It includes functions to: -Find separation distance between lines
...
// Shift_top_line takes a distance beteween two lines and shifts the top line by
// dist/2.
...
// Shift_bottom_line takes a distance beteween two lines and shifts the bottom
// line by dist/2.
...
// Shift_width takes a shift distance and a line and shifts every x value over
// by dist.
