...
struct ExpressionBase {
  ExpressionBase(const expr::ExpressionType &type) : type(type), refcount(0) {}
...
struct ExpressionConst : ExpressionBase {
  ExpressionConst(unsigned val) : ExpressionBase(expr::ExprConst), val(val) {}
...
struct ExpressionBinOp : public ExpressionBase {
  ExpressionBinOp(ExpressionBase *left, ExpressionBase *right,
...
struct ExpressionUnOp : ExpressionBase {
  ...
  virtual ~ExpressionUnOp() { expr->deleteSelf(); }
...
struct ExpressionUnOpCst : ExpressionBase {
  ExpressionUnOpCst(ExpressionBase *expr, int val,
                    expr::ExpressionUnOperatorCst op)
      : ExpressionBase(expr::ExprUnOpCst), expr(expr), val(val), op(op) {
    expr->addRef();
  }
  virtual ~ExpressionUnOpCst() { expr->deleteSelf(); }
...
struct ExpressionSlice : ExpressionBase {
  ...
  virtual ~ExpressionSlice() { expr->deleteSelf(); }
