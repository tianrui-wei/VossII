...
public:
  IoIter inp_begin() const { return IoIter(new InnerIoIter(this, wireInput)); }
  IoIter out_begin() const { return IoIter(new InnerIoIter(this, wireOutput)); }
  IoIter out_end() const { return IoIter(new InnerIoIter(this, NULL)); }
  // ========= END I/O ITERATOR =========================================
