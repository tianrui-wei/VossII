...
public:
  IoIter inp_begin() const {
    return IoIter(new InnerIoIter(this, grpInputs.begin()));
  }
  IoIter out_begin() const {
    return IoIter(new InnerIoIter(this, grpOutputs.begin()));
  }
  IoIter out_end() const {
    return IoIter(new InnerIoIter(this, grpOutputs.end()));
  }
  // ========= END I/O ITERATOR =========================================
