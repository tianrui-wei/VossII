...
protected:
  ...
  public:
    ...
    bool operator!=(InnerIoIter &oth) { return !(operator==(oth)); }
  ...
  protected:
     ...
     */
    virtual bool equal(const InnerIoIter &) const { return true; }
  };
...
public:
  ...
  public:
    ...
    IoIter(const IoIter &oth) : inner(oth.inner->clone()) {}
    ...
    bool operator!=(const IoIter &oth) const { return !(operator==(oth)); }
