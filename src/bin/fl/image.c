...
static int image_sha256_fn(int *g_cntp, hash_record *g_tblp, SHA256_ptr sha,
                           pointer a);
...
void Image_Init() {
  ...
  //
  image_oidx = Add_ExtAPI_Object("image", mark_image_fn, sweep_image_fn,
                                 save_image_fn, load_image_fn, image2str_fn,
                                 image_eq_fn, NULL, NULL, image_sha256_fn);
...
static void import_xpm_image(g_ptr redex) {
  g_ptr g_file;
  EXTRACT_1_ARG(redex, g_file);
  string file = GET_STRING(g_file);
  FILE *fp = fopen(file, "r");
  if (fp == NULL) {
    MAKE_REDEX_FAILURE(redex, Fail_pr("Cannot open file %s for reading", file));
    return;
  }
...
static void image_size(g_ptr redex) {
  g_ptr g_image;
...
static void image_get_pixel(g_ptr redex) {
  ...
  g_ptr rgb =
      Make_CONS_ND(Make_INT_leaf(cp->r),
                   Make_CONS_ND(Make_INT_leaf(cp->g), Make_INT_leaf(cp->b)));
...
static void export_to_ppm(g_ptr redex) {
  ...
  if (fp == NULL) {
    MAKE_REDEX_FAILURE(redex, Fail_pr("Cannot open file %s for writing", file));
    return;
  }
  fprintf(fp, "P6\n%d %d\n255\n", ip->cols, ip->rows);
...
static void hsv_filter(g_ptr redex) {
...
void Image_Install_Functions() {
      ...
      GLmake_arrow(
          ...
          GLmake_arrow(
              ...
              GLmake_arrow(
                  ...
                  GLmake_arrow(
                      GLmake_tuple(GLmake_int(), GLmake_int()),
                      GLmake_arrow(GLmake_tuple(GLmake_int(),
  ...
  Add_ExtAPI_Function(
      "export_to_ppm", "11", FALSE,
      GLmake_arrow(image_handle_tp,
                   GLmake_arrow(GLmake_string(), GLmake_void())),
      export_to_ppm);

  Add_ExtAPI_Function(
      "image_size", "1", FALSE,
      GLmake_arrow(image_handle_tp, GLmake_tuple(GLmake_int(), GLmake_int())),
      image_size);

  Add_ExtAPI_Function(
      "image_get_pixel", "111", FALSE,
      GLmake_arrow(
          image_handle_tp,
          GLmake_arrow(
              GLmake_int(),
...
static formula image_eq_fn(pointer p1, pointer p2, bool identical) {
  ...
  if (ip1->rows != ip2->rows) {
    return (B_Zero());
  }
  if (ip1->cols != ip2->cols) {
    return (B_Zero());
  }
...
static void create_X11_color_map() {
  ...
  //
  insert_hash(&X11_colors, wastrsave(&strings, "snow"), mk_rgb(255, 250, 250));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "OldLace"),
              mk_rgb(253, 245, 230));
  insert_hash(&X11_colors, wastrsave(&strings, "linen"), mk_rgb(250, 240, 230));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "cornsilk"),
              mk_rgb(255, 248, 220));
  insert_hash(&X11_colors, wastrsave(&strings, "ivory"), mk_rgb(255, 255, 240));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "MintCream"),
              mk_rgb(245, 255, 250));
  insert_hash(&X11_colors, wastrsave(&strings, "azure"), mk_rgb(240, 255, 255));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "MistyRose"),
              mk_rgb(255, 228, 225));
  insert_hash(&X11_colors, wastrsave(&strings, "white"), mk_rgb(255, 255, 255));
  insert_hash(&X11_colors, wastrsave(&strings, "black"), mk_rgb(0, 0, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "LightSlateGrey"),
              mk_rgb(119, 136, 153));
  insert_hash(&X11_colors, wastrsave(&strings, "gray"), mk_rgb(190, 190, 190));
  insert_hash(&X11_colors, wastrsave(&strings, "grey"), mk_rgb(190, 190, 190));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "MidnightBlue"),
              mk_rgb(25, 25, 112));
  insert_hash(&X11_colors, wastrsave(&strings, "navy"), mk_rgb(0, 0, 128));
  insert_hash(&X11_colors, wastrsave(&strings, "navy blue"), mk_rgb(0, 0, 128));
  insert_hash(&X11_colors, wastrsave(&strings, "NavyBlue"), mk_rgb(0, 0, 128));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "RoyalBlue"),
              mk_rgb(65, 105, 225));
  insert_hash(&X11_colors, wastrsave(&strings, "blue"), mk_rgb(0, 0, 255));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "turquoise"),
              mk_rgb(64, 224, 208));
  insert_hash(&X11_colors, wastrsave(&strings, "cyan"), mk_rgb(0, 255, 255));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "dark green"),
              mk_rgb(0, 100, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "DarkGreen"), mk_rgb(0, 100, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "LawnGreen"),
              mk_rgb(124, 252, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "green"), mk_rgb(0, 255, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "DarkKhaki"),
              mk_rgb(189, 183, 107));
  insert_hash(&X11_colors, wastrsave(&strings, "khaki"), mk_rgb(240, 230, 140));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "LightYellow"),
              mk_rgb(255, 255, 224));
  insert_hash(&X11_colors, wastrsave(&strings, "yellow"), mk_rgb(255, 255, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "gold"), mk_rgb(255, 215, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "SaddleBrown"),
              mk_rgb(139, 69, 19));
  insert_hash(&X11_colors, wastrsave(&strings, "sienna"), mk_rgb(160, 82, 45));
  insert_hash(&X11_colors, wastrsave(&strings, "peru"), mk_rgb(205, 133, 63));
  insert_hash(&X11_colors, wastrsave(&strings, "burlywood"),
              mk_rgb(222, 184, 135));
  insert_hash(&X11_colors, wastrsave(&strings, "beige"), mk_rgb(245, 245, 220));
  insert_hash(&X11_colors, wastrsave(&strings, "wheat"), mk_rgb(245, 222, 179));
  insert_hash(&X11_colors, wastrsave(&strings, "sandy brown"),
              mk_rgb(244, 164, 96));
  insert_hash(&X11_colors, wastrsave(&strings, "SandyBrown"),
              mk_rgb(244, 164, 96));
  insert_hash(&X11_colors, wastrsave(&strings, "tan"), mk_rgb(210, 180, 140));
  insert_hash(&X11_colors, wastrsave(&strings, "chocolate"),
              mk_rgb(210, 105, 30));
  insert_hash(&X11_colors, wastrsave(&strings, "firebrick"),
              mk_rgb(178, 34, 34));
  insert_hash(&X11_colors, wastrsave(&strings, "brown"), mk_rgb(165, 42, 42));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "DeepPink"),
              mk_rgb(255, 20, 147));
  insert_hash(&X11_colors, wastrsave(&strings, "pink"), mk_rgb(255, 192, 203));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "PaleVioletRed"),
              mk_rgb(219, 112, 147));
  insert_hash(&X11_colors, wastrsave(&strings, "maroon"), mk_rgb(176, 48, 96));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "VioletRed"),
              mk_rgb(208, 32, 144));
  insert_hash(&X11_colors, wastrsave(&strings, "magenta"), mk_rgb(255, 0, 255));
  insert_hash(&X11_colors, wastrsave(&strings, "violet"),
              mk_rgb(238, 130, 238));
  insert_hash(&X11_colors, wastrsave(&strings, "plum"), mk_rgb(221, 160, 221));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "BlueViolet"),
              mk_rgb(138, 43, 226));
  insert_hash(&X11_colors, wastrsave(&strings, "purple"), mk_rgb(160, 32, 240));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "thistle"),
              mk_rgb(216, 191, 216));
  insert_hash(&X11_colors, wastrsave(&strings, "snow1"), mk_rgb(255, 250, 250));
  insert_hash(&X11_colors, wastrsave(&strings, "snow2"), mk_rgb(238, 233, 233));
  insert_hash(&X11_colors, wastrsave(&strings, "snow3"), mk_rgb(205, 201, 201));
  insert_hash(&X11_colors, wastrsave(&strings, "snow4"), mk_rgb(139, 137, 137));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "RoyalBlue4"),
              mk_rgb(39, 64, 139));
  insert_hash(&X11_colors, wastrsave(&strings, "blue1"), mk_rgb(0, 0, 255));
  insert_hash(&X11_colors, wastrsave(&strings, "blue2"), mk_rgb(0, 0, 238));
  insert_hash(&X11_colors, wastrsave(&strings, "blue3"), mk_rgb(0, 0, 205));
  insert_hash(&X11_colors, wastrsave(&strings, "blue4"), mk_rgb(0, 0, 139));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "turquoise4"),
              mk_rgb(0, 134, 139));
  insert_hash(&X11_colors, wastrsave(&strings, "cyan1"), mk_rgb(0, 255, 255));
  insert_hash(&X11_colors, wastrsave(&strings, "cyan2"), mk_rgb(0, 238, 238));
  insert_hash(&X11_colors, wastrsave(&strings, "cyan3"), mk_rgb(0, 205, 205));
  insert_hash(&X11_colors, wastrsave(&strings, "cyan4"), mk_rgb(0, 139, 139));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "SpringGreen4"),
              mk_rgb(0, 139, 69));
  insert_hash(&X11_colors, wastrsave(&strings, "green1"), mk_rgb(0, 255, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "green2"), mk_rgb(0, 238, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "green3"), mk_rgb(0, 205, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "green4"), mk_rgb(0, 139, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "khaki3"),
              mk_rgb(205, 198, 115));
  insert_hash(&X11_colors, wastrsave(&strings, "khaki4"), mk_rgb(139, 134, 78));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "LightYellow4"),
              mk_rgb(139, 139, 122));
  insert_hash(&X11_colors, wastrsave(&strings, "yellow1"), mk_rgb(255, 255, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "yellow2"), mk_rgb(238, 238, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "yellow3"), mk_rgb(205, 205, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "yellow4"), mk_rgb(139, 139, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "gold1"), mk_rgb(255, 215, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "gold2"), mk_rgb(238, 201, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "gold3"), mk_rgb(205, 173, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "gold4"), mk_rgb(139, 117, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "sienna3"),
              mk_rgb(205, 104, 57));
  insert_hash(&X11_colors, wastrsave(&strings, "sienna4"), mk_rgb(139, 71, 38));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "wheat4"),
              mk_rgb(139, 126, 102));
  insert_hash(&X11_colors, wastrsave(&strings, "tan1"), mk_rgb(255, 165, 79));
  insert_hash(&X11_colors, wastrsave(&strings, "tan2"), mk_rgb(238, 154, 73));
  insert_hash(&X11_colors, wastrsave(&strings, "tan3"), mk_rgb(205, 133, 63));
  insert_hash(&X11_colors, wastrsave(&strings, "tan4"), mk_rgb(139, 90, 43));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "firebrick4"),
              mk_rgb(139, 26, 26));
  insert_hash(&X11_colors, wastrsave(&strings, "brown1"), mk_rgb(255, 64, 64));
  insert_hash(&X11_colors, wastrsave(&strings, "brown2"), mk_rgb(238, 59, 59));
  insert_hash(&X11_colors, wastrsave(&strings, "brown3"), mk_rgb(205, 51, 51));
  insert_hash(&X11_colors, wastrsave(&strings, "brown4"), mk_rgb(139, 35, 35));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "salmon3"),
              mk_rgb(205, 112, 84));
  insert_hash(&X11_colors, wastrsave(&strings, "salmon4"), mk_rgb(139, 76, 57));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "LightSalmon4"),
              mk_rgb(139, 87, 66));
  insert_hash(&X11_colors, wastrsave(&strings, "orange1"), mk_rgb(255, 165, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "orange2"), mk_rgb(238, 154, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "orange3"), mk_rgb(205, 133, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "orange4"), mk_rgb(139, 90, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "DarkOrange4"),
              mk_rgb(139, 69, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "coral1"), mk_rgb(255, 114, 86));
  insert_hash(&X11_colors, wastrsave(&strings, "coral2"), mk_rgb(238, 106, 80));
  insert_hash(&X11_colors, wastrsave(&strings, "coral3"), mk_rgb(205, 91, 69));
  insert_hash(&X11_colors, wastrsave(&strings, "coral4"), mk_rgb(139, 62, 47));
  insert_hash(&X11_colors, wastrsave(&strings, "tomato1"), mk_rgb(255, 99, 71));
  insert_hash(&X11_colors, wastrsave(&strings, "tomato2"), mk_rgb(238, 92, 66));
  insert_hash(&X11_colors, wastrsave(&strings, "tomato3"), mk_rgb(205, 79, 57));
  insert_hash(&X11_colors, wastrsave(&strings, "tomato4"), mk_rgb(139, 54, 38));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "OrangeRed4"),
              mk_rgb(139, 37, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "red1"), mk_rgb(255, 0, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "red2"), mk_rgb(238, 0, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "red3"), mk_rgb(205, 0, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "red4"), mk_rgb(139, 0, 0));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "HotPink4"),
              mk_rgb(139, 58, 98));
  insert_hash(&X11_colors, wastrsave(&strings, "pink1"), mk_rgb(255, 181, 197));
  insert_hash(&X11_colors, wastrsave(&strings, "pink2"), mk_rgb(238, 169, 184));
  insert_hash(&X11_colors, wastrsave(&strings, "pink3"), mk_rgb(205, 145, 158));
  insert_hash(&X11_colors, wastrsave(&strings, "pink4"), mk_rgb(139, 99, 108));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "maroon3"),
              mk_rgb(205, 41, 144));
  insert_hash(&X11_colors, wastrsave(&strings, "maroon4"), mk_rgb(139, 28, 98));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "orchid4"),
              mk_rgb(139, 71, 137));
  insert_hash(&X11_colors, wastrsave(&strings, "plum1"), mk_rgb(255, 187, 255));
  insert_hash(&X11_colors, wastrsave(&strings, "plum2"), mk_rgb(238, 174, 238));
  insert_hash(&X11_colors, wastrsave(&strings, "plum3"), mk_rgb(205, 150, 205));
  insert_hash(&X11_colors, wastrsave(&strings, "plum4"), mk_rgb(139, 102, 139));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "purple3"),
              mk_rgb(125, 38, 205));
  insert_hash(&X11_colors, wastrsave(&strings, "purple4"), mk_rgb(85, 26, 139));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "thistle4"),
              mk_rgb(139, 123, 139));
  insert_hash(&X11_colors, wastrsave(&strings, "gray0"), mk_rgb(0, 0, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "grey0"), mk_rgb(0, 0, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "gray1"), mk_rgb(3, 3, 3));
  insert_hash(&X11_colors, wastrsave(&strings, "grey1"), mk_rgb(3, 3, 3));
  insert_hash(&X11_colors, wastrsave(&strings, "gray2"), mk_rgb(5, 5, 5));
  insert_hash(&X11_colors, wastrsave(&strings, "grey2"), mk_rgb(5, 5, 5));
  insert_hash(&X11_colors, wastrsave(&strings, "gray3"), mk_rgb(8, 8, 8));
  insert_hash(&X11_colors, wastrsave(&strings, "grey3"), mk_rgb(8, 8, 8));
  insert_hash(&X11_colors, wastrsave(&strings, "gray4"), mk_rgb(10, 10, 10));
  insert_hash(&X11_colors, wastrsave(&strings, "grey4"), mk_rgb(10, 10, 10));
  insert_hash(&X11_colors, wastrsave(&strings, "gray5"), mk_rgb(13, 13, 13));
  insert_hash(&X11_colors, wastrsave(&strings, "grey5"), mk_rgb(13, 13, 13));
  insert_hash(&X11_colors, wastrsave(&strings, "gray6"), mk_rgb(15, 15, 15));
  insert_hash(&X11_colors, wastrsave(&strings, "grey6"), mk_rgb(15, 15, 15));
  insert_hash(&X11_colors, wastrsave(&strings, "gray7"), mk_rgb(18, 18, 18));
  insert_hash(&X11_colors, wastrsave(&strings, "grey7"), mk_rgb(18, 18, 18));
  insert_hash(&X11_colors, wastrsave(&strings, "gray8"), mk_rgb(20, 20, 20));
  insert_hash(&X11_colors, wastrsave(&strings, "grey8"), mk_rgb(20, 20, 20));
  insert_hash(&X11_colors, wastrsave(&strings, "gray9"), mk_rgb(23, 23, 23));
  insert_hash(&X11_colors, wastrsave(&strings, "grey9"), mk_rgb(23, 23, 23));
  insert_hash(&X11_colors, wastrsave(&strings, "gray10"), mk_rgb(26, 26, 26));
  insert_hash(&X11_colors, wastrsave(&strings, "grey10"), mk_rgb(26, 26, 26));
  insert_hash(&X11_colors, wastrsave(&strings, "gray11"), mk_rgb(28, 28, 28));
  insert_hash(&X11_colors, wastrsave(&strings, "grey11"), mk_rgb(28, 28, 28));
  insert_hash(&X11_colors, wastrsave(&strings, "gray12"), mk_rgb(31, 31, 31));
  insert_hash(&X11_colors, wastrsave(&strings, "grey12"), mk_rgb(31, 31, 31));
  insert_hash(&X11_colors, wastrsave(&strings, "gray13"), mk_rgb(33, 33, 33));
  insert_hash(&X11_colors, wastrsave(&strings, "grey13"), mk_rgb(33, 33, 33));
  insert_hash(&X11_colors, wastrsave(&strings, "gray14"), mk_rgb(36, 36, 36));
  insert_hash(&X11_colors, wastrsave(&strings, "grey14"), mk_rgb(36, 36, 36));
  insert_hash(&X11_colors, wastrsave(&strings, "gray15"), mk_rgb(38, 38, 38));
  insert_hash(&X11_colors, wastrsave(&strings, "grey15"), mk_rgb(38, 38, 38));
  insert_hash(&X11_colors, wastrsave(&strings, "gray16"), mk_rgb(41, 41, 41));
  insert_hash(&X11_colors, wastrsave(&strings, "grey16"), mk_rgb(41, 41, 41));
  insert_hash(&X11_colors, wastrsave(&strings, "gray17"), mk_rgb(43, 43, 43));
  insert_hash(&X11_colors, wastrsave(&strings, "grey17"), mk_rgb(43, 43, 43));
  insert_hash(&X11_colors, wastrsave(&strings, "gray18"), mk_rgb(46, 46, 46));
  insert_hash(&X11_colors, wastrsave(&strings, "grey18"), mk_rgb(46, 46, 46));
  insert_hash(&X11_colors, wastrsave(&strings, "gray19"), mk_rgb(48, 48, 48));
  insert_hash(&X11_colors, wastrsave(&strings, "grey19"), mk_rgb(48, 48, 48));
  insert_hash(&X11_colors, wastrsave(&strings, "gray20"), mk_rgb(51, 51, 51));
  insert_hash(&X11_colors, wastrsave(&strings, "grey20"), mk_rgb(51, 51, 51));
  insert_hash(&X11_colors, wastrsave(&strings, "gray21"), mk_rgb(54, 54, 54));
  insert_hash(&X11_colors, wastrsave(&strings, "grey21"), mk_rgb(54, 54, 54));
  insert_hash(&X11_colors, wastrsave(&strings, "gray22"), mk_rgb(56, 56, 56));
  insert_hash(&X11_colors, wastrsave(&strings, "grey22"), mk_rgb(56, 56, 56));
  insert_hash(&X11_colors, wastrsave(&strings, "gray23"), mk_rgb(59, 59, 59));
  insert_hash(&X11_colors, wastrsave(&strings, "grey23"), mk_rgb(59, 59, 59));
  insert_hash(&X11_colors, wastrsave(&strings, "gray24"), mk_rgb(61, 61, 61));
  insert_hash(&X11_colors, wastrsave(&strings, "grey24"), mk_rgb(61, 61, 61));
  insert_hash(&X11_colors, wastrsave(&strings, "gray25"), mk_rgb(64, 64, 64));
  insert_hash(&X11_colors, wastrsave(&strings, "grey25"), mk_rgb(64, 64, 64));
  insert_hash(&X11_colors, wastrsave(&strings, "gray26"), mk_rgb(66, 66, 66));
  insert_hash(&X11_colors, wastrsave(&strings, "grey26"), mk_rgb(66, 66, 66));
  insert_hash(&X11_colors, wastrsave(&strings, "gray27"), mk_rgb(69, 69, 69));
  insert_hash(&X11_colors, wastrsave(&strings, "grey27"), mk_rgb(69, 69, 69));
  insert_hash(&X11_colors, wastrsave(&strings, "gray28"), mk_rgb(71, 71, 71));
  insert_hash(&X11_colors, wastrsave(&strings, "grey28"), mk_rgb(71, 71, 71));
  insert_hash(&X11_colors, wastrsave(&strings, "gray29"), mk_rgb(74, 74, 74));
  insert_hash(&X11_colors, wastrsave(&strings, "grey29"), mk_rgb(74, 74, 74));
  insert_hash(&X11_colors, wastrsave(&strings, "gray30"), mk_rgb(77, 77, 77));
  insert_hash(&X11_colors, wastrsave(&strings, "grey30"), mk_rgb(77, 77, 77));
  insert_hash(&X11_colors, wastrsave(&strings, "gray31"), mk_rgb(79, 79, 79));
  insert_hash(&X11_colors, wastrsave(&strings, "grey31"), mk_rgb(79, 79, 79));
  insert_hash(&X11_colors, wastrsave(&strings, "gray32"), mk_rgb(82, 82, 82));
  insert_hash(&X11_colors, wastrsave(&strings, "grey32"), mk_rgb(82, 82, 82));
  insert_hash(&X11_colors, wastrsave(&strings, "gray33"), mk_rgb(84, 84, 84));
  insert_hash(&X11_colors, wastrsave(&strings, "grey33"), mk_rgb(84, 84, 84));
  insert_hash(&X11_colors, wastrsave(&strings, "gray34"), mk_rgb(87, 87, 87));
  insert_hash(&X11_colors, wastrsave(&strings, "grey34"), mk_rgb(87, 87, 87));
  insert_hash(&X11_colors, wastrsave(&strings, "gray35"), mk_rgb(89, 89, 89));
  insert_hash(&X11_colors, wastrsave(&strings, "grey35"), mk_rgb(89, 89, 89));
  insert_hash(&X11_colors, wastrsave(&strings, "gray36"), mk_rgb(92, 92, 92));
  insert_hash(&X11_colors, wastrsave(&strings, "grey36"), mk_rgb(92, 92, 92));
  insert_hash(&X11_colors, wastrsave(&strings, "gray37"), mk_rgb(94, 94, 94));
  insert_hash(&X11_colors, wastrsave(&strings, "grey37"), mk_rgb(94, 94, 94));
  insert_hash(&X11_colors, wastrsave(&strings, "gray38"), mk_rgb(97, 97, 97));
  insert_hash(&X11_colors, wastrsave(&strings, "grey38"), mk_rgb(97, 97, 97));
  insert_hash(&X11_colors, wastrsave(&strings, "gray39"), mk_rgb(99, 99, 99));
  insert_hash(&X11_colors, wastrsave(&strings, "grey39"), mk_rgb(99, 99, 99));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "DarkGray"),
              mk_rgb(169, 169, 169));
  insert_hash(&X11_colors, wastrsave(&strings, "dark blue"), mk_rgb(0, 0, 139));
  insert_hash(&X11_colors, wastrsave(&strings, "DarkBlue"), mk_rgb(0, 0, 139));
  ...
  insert_hash(&X11_colors, wastrsave(&strings, "DarkMagenta"),
              mk_rgb(139, 0, 139));
  insert_hash(&X11_colors, wastrsave(&strings, "dark red"), mk_rgb(139, 0, 0));
  insert_hash(&X11_colors, wastrsave(&strings, "DarkRed"), mk_rgb(139, 0, 0));
