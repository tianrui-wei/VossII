...
VOID Init_file_ops() { LL_file.file_desc = -1; }

/* Quit_file_ops -- Release the file operation manager */
VOID Quit_file_ops() { LL_file.file_desc = -1; }
...
bool LL_Open(string filename, char op) {
  string new_name;
  bool res;
