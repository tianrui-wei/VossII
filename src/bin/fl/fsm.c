...
/*									*/
/************************************************************************/
#include "vstrings.h"	// Need the vector/node name data structures
#include "fsm.h"
#include "graph.h"
#include "pexlif.h"
...
Fsm_Init()
{
	...
	for (size_t i = 0; i < sizeof(state_holding_names) / sizeof(state_holding_names[0]); i++)
	{
		string *p = &state_holding_names[i];
