...
static void do_srandom(g_ptr redex) {
...
static void do_random2(g_ptr redex) {
  g_ptr l = GET_APPLY_LEFT(redex);
  g_ptr r = GET_APPLY_RIGHT(redex);
  int bits = GET_INT(r);
...
static void iUNARY_MINUS(g_ptr redex) {
  g_ptr l = GET_APPLY_LEFT(redex);
  g_ptr r = GET_APPLY_RIGHT(redex);
...
static void iMINUS(g_ptr redex) {
  g_ptr l = GET_APPLY_LEFT(redex);
  g_ptr r = GET_APPLY_RIGHT(redex);
  arbi_T ai1 = GET_AINT(GET_APPLY_RIGHT(l));
  arbi_T ai2 = GET_AINT(r);
...
static void iTIMES(g_ptr redex) {
  g_ptr l = GET_APPLY_LEFT(redex);
  g_ptr r = GET_APPLY_RIGHT(redex);
  arbi_T ai1 = GET_AINT(GET_APPLY_RIGHT(l));
  arbi_T ai2 = GET_AINT(r);
...
static void iDIVIDE(g_ptr redex) {
  g_ptr l = GET_APPLY_LEFT(redex);
  g_ptr r = GET_APPLY_RIGHT(redex);
  arbi_T ai1 = GET_AINT(GET_APPLY_RIGHT(l));
  arbi_T ai2 = GET_AINT(r);
...
static void iGREATER(g_ptr redex) {
  g_ptr l = GET_APPLY_LEFT(redex);
  g_ptr r = GET_APPLY_RIGHT(redex);
  arbi_T ai1 = GET_AINT(GET_APPLY_RIGHT(l));
  arbi_T ai2 = GET_AINT(r);
...
void Int_ops_Install_Functions() {
  ...
  Add_ExtAPI_Function("srandom", "1", FALSE,
                      GLmake_arrow(GLmake_int(), GLmake_void()), do_srandom);

  Add_ExtAPI_Function("random2", "1", FALSE,
                      GLmake_arrow(GLmake_int(), GLmake_int()), do_random2);

  Add_ExtAPI_Function(
      "+", "11", FALSE,
      GLmake_arrow(GLmake_int(), GLmake_arrow(GLmake_int(), GLmake_int())),
      iPLUS);
  Insert_infix("+", 7);

  Add_ExtAPI_Function("!unary_minus!", "1", FALSE,
                      GLmake_arrow(GLmake_int(), GLmake_int()), iUNARY_MINUS);
  ...
  Add_ExtAPI_Function("intNOT", "1", FALSE,
                      GLmake_arrow(GLmake_int(), GLmake_int()), iNOT);
  ...
  Add_ExtAPI_Function(
      "<", "11", FALSE,
      GLmake_arrow(GLmake_int(), GLmake_arrow(GLmake_int(), GLmake_bool())),
      iLESS);
  Insert_infix("<", 5);
